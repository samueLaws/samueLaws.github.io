class Node {
    ...
    constructor(i,x,y,connections,fullList){
        ...
        this.size = 10;
        this.lowerBoundConnections = connections;
        this.closestNeighbours = [];
        this.closestNeighbourCosts = [];
        this.farthestNeigbourCost = 0;
    ...
    fillClosestNeighbourCosts(){
        this.closestNeighbourCosts.length = this.closestNeighbours.length
        for(let i = 0; i < this.closestNeighbours.length; i++){
            this.closestNeighbourCosts[i] = this.getDistTo(this.closestNeighbours[i]);
        }
    }
    getHighestNeighbourCost(){
        this.fillClosestNeighbourCosts();
        let cost = 0;
        for(let i = 0; i < this.closestNeighbourCosts.length; i++){
            if(this.closestNeighbourCosts[i] > cost){
                cost = this.closestNeighbourCosts[i];
            }
        }
        this.farthestNeigbourCost = cost;
        return cost;
    }
    ...
    resetNeighbours(){
        this.closestNeighbours = [];
        this.closestNeighbourCosts = [];
        this.closestNeighbours.length = this.lowerBoundConnections;
        this.closestNeighbourCosts.length = this.lowerBoundConnections;
    }
    getPos(){
        return this.pos;
    }
